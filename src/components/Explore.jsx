  ...
  return (
    <>
      <Link
        ...
        ref={leftDivRef}
        className='md:w-[50%] cursor-pointer text-white md:h-full sm:h-[50%] bg-[url("https://www.styleglow.com/wp-content/uploads/2018/04/Printed-Blue-Sherwani-Design-for-Barat-1031x1547.jpg")] bg-cover flex flex-col justify-end items-center sm:pb-20 sm:gap-5 font-prag explore-div-left'
      >
      ...
      <Link
        href={'/list?cat=legowns-special'}
        ref={rightDivRef}
        className='md:w-[50%] cursor-pointer text-white md:h-full sm:h-[50%] bg-[url("https://www.styleglow.com/wp-content/uploads/2020/02/Sapphire-Eid-Unstitiched-dresess.jpg")] bg-cover flex flex-col justify-end items-center sm:pb-20 sm:gap-5 font-prag explore-div-right'
      >
