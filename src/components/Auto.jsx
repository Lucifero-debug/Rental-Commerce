    ...
    <div className="img flex w-full justify-center gap-4">
      {auto.map((item, index) => (
        ...
        <Image
          ...
          className={`w-[24vw] cursor-pointer transition-transform duration-700 ease-in-out shadow-[20px_10px_30px_rgba(121,90,58,1)] ${activeIndex === index ? 'scale-110 translate-x-4' : 'scale-75'}`}
          width={300}
          height={300}
        />
        </Link>
